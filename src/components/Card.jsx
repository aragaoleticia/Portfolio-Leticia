...
export default function Card({title, description, img, techs, liveDemo, github}) {
  return (
    <div className='p-6 overflow-hidden shadow-xl max-w-md transform bg-gray-50 rounded-lg hover:scale-105 transition-transform duration-300'>
        <h2 className='font-bold text-2xl mb-4 text-main-color underline'>{title}</h2>
        <img src={img} 
        alt='project print' 
    ...
    <div className='flex gap-4 justify-center'>
        ...
        <a className='bg-main-color text-white flex items-center gap-2 py-2 px-4 rounded-lg hover:bg-purple-700 transition duration-300' 
            rel='noreferrer'
            href={github}
            target="_blank"
        >
